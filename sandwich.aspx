...
<%@ Page Title="" Language="C#" MasterPageFile="~/FoodLounge.Master" AutoEventWireup="true" CodeBehind="sandwich.aspx.cs" Inherits="FoodLounge.sandwich" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">
    <br />
        ...
        <tr>
            ...
            <td colspan="2" style="border: thin solid black;text-align:center; height: 74px;font-size:25px; color:black" >SANDWICH</td>
        ...
        <tr>
            <td style="border: thin solid black;align-content:center;"class="auto-style1">
                <br />
                <asp:ImageButton ID="imgbtnsandwich1" runat="server" ImageUrl="~/img/chicken-sandwitch.jpg" Height="150px" Width="180px" OnClick="imgbtnsandwich1_Click"/>
                <br />
                Chicken Sandwich<br />
                ☆☆☆☆☆<br />
                Rs. 70
            ...
            <td style="border: thin solid black;align-content:center;"class="auto-style1">
                <br />
                <asp:ImageButton ID="imgbtnsandwich2" runat="server" ImageUrl="~/img/egg-sandwitch.jpg" Height="150px" Width="180px" OnClick="imgbtnsandwich2_Click"/>
                <br />
                Egg Sandwich<br />
                ☆☆☆☆☆<br />
                Rs. 50
 ...
 <tr>
            <td style="border: thin solid black;align-content:center;"class="auto-style1">
                <br />
                <asp:ImageButton ID="imgbtnsandwich3" runat="server" ImageUrl="~/img/nutella-sandwich.jpg" Height="150px" Width="180px" OnClick="imgbtnsandwich3_Click"/>
                <br />
                Nuttella Sandwich<br />
                ☆☆☆☆☆<br />
                Rs. 60
            ...
            <td style="border: thin solid black;align-content:center;"class="auto-style1">
                <br />
                <asp:ImageButton ID="imgbtnsandwich4" runat="server" ImageUrl="~/img/Seafood-Sandwich.jpg" Height="150px" Width="180px" OnClick="imgbtnsandwich4_Click"/>
                <br />
                Seafood Sandwich <br />
                ☆☆☆☆☆<br />
                Rs. 80
