<%@ Page Title="" Language="C#" MasterPageFile="~/FoodLounge.Master" AutoEventWireup="true" CodeBehind="juiceorshake1.aspx.cs" Inherits="FoodLounge.juiceorshake1" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder1" runat="server">
    <asp:Label ID="Label6userid" runat="server" Visible="False"></asp:Label>
<br />
    ...
    <table style="width:100%">
        <tr>
            ...
            <td rowspan="7" class="auto-style4" style="width: 122px">&nbsp;
                <asp:Image ID="Imagejuiceorshake1" runat="server" ImageUrl="~/img/orange-juice.png" style="border-style: inset; border-color: #FF3300; width: 355px; height: 373px"  />
            </td>
        ...
        <tr>
            <td  style="border: thin solid black; font-size: 22px;" class="auto-style18">
                <asp:Label ID="Labelnamejuiceorshake1" runat="server" Text="Name"></asp:Label>
            </td>
            <td  style="border: thin solid black; font-size: 18px;" class="auto-style15">
                <asp:Label ID="Labeljuiceorshake11" runat="server" Text="Orange Juice"></asp:Label>
            </td>
        </tr>
        <tr>
            <td  style="border: thin solid black; font-size: 22px;" class="auto-style18">
                <asp:Label ID="Labelpricejuiceorshake1" runat="server" Text="Price (Rs.)"></asp:Label>
            </td>
            <td  style="border: thin solid black;font-size: 18px;" class="auto-style15">
                <asp:Label ID="Labeljuiceorshake12" runat="server" Text="30"></asp:Label>
            </td>
        </tr>
        <tr>
            <td  style="border: thin solid black;font-size: 22px;" class="auto-style18">
                <asp:Label ID="Labelcategoryjuiceorshake1" runat="server" Text="Category"></asp:Label>
            </td>
            <td  style="border: thin solid black;font-size: 18px;" class="auto-style15">
                <asp:Label ID="Labeljuiceorshake13" runat="server" Text="Juice"></asp:Label>
            </td>
        </tr>
        <tr>
            <td  style="border: thin solid black;font-size: 22px;" class="auto-style18">
                <asp:Label ID="Labeldetailsjuiceorshake1" runat="server" Text="Details"></asp:Label>
            </td>
            <td  style="border: thin solid black;font-size: 18px;" class="auto-style15"> 
                <asp:Label ID="Labeljuiceorshake14" runat="server" Text="Fresh Juice"></asp:Label>
            </td>
        </tr>
        
         <tr>
            <td  style="border: thin solid black;font-size: 22px;" class="auto-style18">
                <asp:Label ID="juiceorshake1quantity" runat="server" Text="Quantity"></asp:Label>
            </td>
            <td  style="border: thin solid black;font-size: 18px;" class="auto-style15">
                <asp:TextBox ID="TextBoxjuiceorshakequantity" runat="server"></asp:TextBox>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBoxjuiceorshakequantity" ErrorMessage="Please Enter Quantity" ForeColor="#CC0000"></asp:RequiredFieldValidator>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="2" style="align-content:center" class="auto-style16">
                ...
                <asp:Button ID="adtocartjuiceorshake1" runat="server" BackColor="#CC3300" BorderColor="Maroon" BorderStyle="Groove" Font-Bold="False" Font-Size="29px" ForeColor="White" Height="50px" Text="Add to Cart" Width="286px" OnClick="adtocartjuiceorshake1_Click" />
